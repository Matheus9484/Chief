...
public class Robot extends TimedRobot {
  ...
  public void autonomousInit() {
    ...
    m_autonomousCommand = m_robotContainer.Autonomo();
  ...
  public void teleopInit() {
    ...
    m_robotContainer.swerve.visao = Constants.AlinhamentoOdometria.visaoTrue && Constants.AlinhamentoOdometria.utilizarVisao ;
    if (m_autonomousCommand != null) {
