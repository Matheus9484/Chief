...
public final class Constants {
  ...
  public static final class Dimensoes {
    ...
    public static class ElevatorConstants {
      ...
      public static final double ELEVATOR_MANUAL_SPEED = 0.15;
    }
    ...
    public static class DeployerIntakeConstants {
      ...
      public static int deployerSensor2 = 4;
      public static int funnelSensor = 2;
  
      public static double intakeSpeed = 0.26;
    }
    ...
    static {
      ...
      ELEVATOR_CONFIG.Slot0.kG = 0; // Volts to overcome gravity
      ELEVATOR_CONFIG.Slot0.kS = 0; // Volts to overcome static friction
      ELEVATOR_CONFIG.Slot0.kV = 0.019; // Volts for a velocity target of 1 rps
      ...
      ELEVATOR_CONFIG.MotionMagic.MotionMagicExpo_kA = 0.03;
    ...
    static {
      ...
      // CLIMBER_CONFIG.CurrentLimits.SupplyCurrentLowerLimit = 30;
      // CLIMBER_CONFIG.CurrentLimits.SupplyCurrentLimit = 80;
      // CLIMBER_CONFIG.CurrentLimits.SupplyCurrentLowerTime = 1;

      ELEVATOR_CONFIG.SoftwareLimitSwitch.ForwardSoftLimitEnable = true;
      ELEVATOR_CONFIG.SoftwareLimitSwitch.ForwardSoftLimitThreshold = 200;
      ELEVATOR_CONFIG.SoftwareLimitSwitch.ReverseSoftLimitEnable = true;
    ...
    public static enum ElevatorState {
      CORAL(5), L1(37), L2(63), L3(111), L4(90);
    ...
    public static enum DeployerState {
      RESHOOTING(-0.14), STOPPED(0), SHOOTING(0.35);
