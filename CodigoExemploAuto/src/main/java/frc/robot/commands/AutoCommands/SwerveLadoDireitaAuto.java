...
public class SwerveLadoDireitaAuto extends Command {
  ...
  public SwerveLadoDireitaAuto(CommandXboxController controleXbox, SwerveSubsystem swerveSubsystem, double timer) {
